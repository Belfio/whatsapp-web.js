...
class Client extends EventEmitter {
    ...
    async initialize() {
        ...
        const chromiumOpts = this.options.puppeteer
        if (chromiumOpts && chromiumOpts.browserWSEndpoint) {
            ...
            if (chromiumOpts.userDataDir) {
                console.log("chromiumOpts", {
                    ...chromiumOpts,
                })
                //   chromiumOpts {
                //     headless: false,
                //     defaultViewport: null,
                //     userDataDir: '/Users/alfredo/NonBackedUp/Code/whatsapp-web.js/.wwebjs_auth/session'
                //   }

                browser = await chromium.launchPersistentContext(
                    chromiumOpts.userDataDir,
                    {
                        headless: false,
                        defaultViewport: null,
                        use: {
    ...
    async sendMessage(chatId, content, options = {}) {
        ...
        const newMessage = await this.pupPage.evaluate(
            async ({ chatId, content, internalOptions, sendSeen }) => {
